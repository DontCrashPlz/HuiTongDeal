...
import com.huitong.deal.activities.TiXianHistoryActivity;
...
public class StoreTiXianActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.store_activity_withdraw_deposit);
    ...
    private void initUI() {
        ...
        mFunctionTv.setText("提现记录");
        mFunctionTv.setVisibility(View.VISIBLE);
        mFunctionTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getRealContext(), StoreTiXianHistoryActivity.class));
            }
        });

        mNameEt = findViewById(R.id.tixian_et_name);
        mBankCardEt = findViewById(R.id.tixian_et_bankcard);
        mKaiHuHangEt= findViewById(R.id.tixian_et_kaihuhang);
        mKaiHuZhiHangEt= findViewById(R.id.tixian_et_kaihuzhihang);
        mMaxTv= findViewById(R.id.tixian_tv_max);
        mMoneyEt = findViewById(R.id.tixian_et_money);
        if (MyApplication.appUser.getUserinfo()!= null){
            float availableBalance= MyApplication.appUser.getUserinfo().getAvailablebalance();
            mMaxTv.setText(String.format(getString(R.string.store_tixian_max), String.valueOf(availableBalance)));
        }else {
            mMaxTv.setText(String.format(getString(R.string.store_tixian_max), "0"));
        }
