...
public class ChiCangHistoryListAdapter extends BaseQuickAdapter<ChiCangHistoryEntity2, ChiCangHistoryListAdapter.ChiCangListHolder> {
    ...
    @Override
    protected void convert(ChiCangListHolder helper, final ChiCangHistoryEntity2 item) {
        ...
        helper.mText1.setText(item.getStock_name());
        ...
        helper.mText6.setText("平仓");
        helper.mText7.setText(Tools.formatFloat(item.getEnd_price()));
